...
const SingleItem = ({ index, singleItem, edit, deleteItem, setEdit,setEditingIndex }) => {

  return (
    <div className='singleItem'>
      {singleItem}

      <div className="singleItem_btnGrp">
        <button className='singleItem_btnGrp_edit' onClick={() => {
            setEdit(true)
        ...
        <button className='singleItem_btnGrp_del' disabled={edit ? true : false} onClick={() => deleteItem(index)}>
